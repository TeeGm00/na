...
for i in range(NUM): #ให้มันรันตามจำนวนที่เรากำหนด
	threading.Thread(target=api1).start() #นี่คือรันapiที่1
	
#จบถ้าจะทำยิงเบอร์แจกแนะนำใส่เครดิตEH4404ด้วยบอกเลยดัง